...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V,  KC_B,           KC_LGUI,         KC_RGUI,        KC_K,           KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_EQL,
                                   MO(3), LALT_T(KC_DEL), LSFT_T(KC_BSPC), RSFT_T(KC_SPC), RALT_T(KC_ENT), MO(4)),
    [1] = LAYOUT(
        QK_GESC, KC_1, KC_2, KC_3, KC_4,  KC_5,                                            KC_6,           KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS,
    ...
    [3] = LAYOUT(
        ...
        QK_BOOT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_MINS, KC_TRNS, KC_TRNS, KC_EQL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS,
    ...
    [4] = LAYOUT(
        ...
        KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, QK_BOOT,
                                          MO(5),   KC_BTN1, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS),
    [5] = LAYOUT(
        KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                 KC_NO, KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, RGB_TOG, RGB_SPI, RGB_HUI, RGB_SAI, RGB_VAI,               KC_NO, KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, RGB_MOD, RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD,               KC_NO, DF(0),   DF(1), DF(2), KC_NO, KC_NO,
